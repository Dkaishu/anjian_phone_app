...
public class UpLoadModel {
		...
		private void HilightChosenImg(int imgId) {
			...
			allImgId.set(R.drawable.all_btn_up);
			weiImgId.set(R.drawable.unupload_btn_up);
			yiImgId.set(R.drawable.uploaded_btn_up);
			weixiuImgId.set(R.drawable.weixiu_btn_up);
			if(imgId == R.drawable.all_btn_hover_up)
			{
				allImgId.set(imgId);
			}
			else if(imgId == R.drawable.unupload_btn_hover_up)
			{
				weiImgId.set(imgId);
			}
			else if(imgId == R.drawable.uploaded_btn_hover_up)
			{
				yiImgId.set(imgId);
			}		
			else if(imgId == R.drawable.weixiu_btn_hover_up)
			{
				weixiuImgId.set(imgId);
			}		
		}
		public IntegerObservable allImgId = new IntegerObservable(R.drawable.all_btn_hover_up);
		public Command AllClicked = new Command(){
			public void Invoke(View view, Object... args) {
				UpLoadModel.this.HilightChosenImg(R.drawable.all_btn_hover_up);
				listByExample(0, false);
			}
		};
		
		public IntegerObservable weiImgId = new IntegerObservable(R.drawable.unupload_btn_up);
		public Command WeiImgClicked = new Command(){
			public void Invoke(View view, Object... args) {
				UpLoadModel.this.HilightChosenImg(R.drawable.unupload_btn_hover_up);
				listByExample(Vault.UPLOAD_FLAG, false);
			}
		};

		public IntegerObservable yiImgId = new IntegerObservable(R.drawable.uploaded_btn_up);
		public Command YiImgClicked = new Command(){
			public void Invoke(View view, Object... args) {
				UpLoadModel.this.HilightChosenImg(R.drawable.uploaded_btn_hover_up);
				listByExample(Vault.UPLOAD_FLAG, true);
			}
		};
		public IntegerObservable weixiuImgId = new IntegerObservable(R.drawable.weixiu_btn_up);
		public Command WeixiuImgClicked = new Command(){
			public void Invoke(View view, Object... args) {
				UpLoadModel.this.HilightChosenImg(R.drawable.weixiu_btn_hover_up);
		...
		public Command AutoUpload = new Command(){
			public void Invoke(View view, Object... args) {
				...
				{
					btnUpload.setBackgroundResource(R.drawable.uploadbtn_quxiao);
					cancelable = true;
					canceled = false;
				}
		...
		public void listByExample(int mask, boolean IsSet) {
			...
			uploadList.clear();
			while (c.moveToNext()) {
				String address = c.getString(2)  + " " + c.getString(3)  + " "+c.getString(4) + " " +c.getString(5) + " " +c.getString(6) ; 
